...
var techs = document.querySelector('.modal__techs');
var desc = document.querySelector('.modal__desc');
var code = document.querySelector('.modal__code');
var site = document.querySelector('.modal__site');
...
function getId(e) {
    ...
    var site = sites.filter(function (item) { return item.id === e.target.dataset.id; });
    createModal(site[0]);
    openModal();
}
